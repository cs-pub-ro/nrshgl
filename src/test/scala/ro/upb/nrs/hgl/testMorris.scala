...
class TestAdditionSingleMorris extends AnyFlatSpec with ChiselScalatestTester{
    behavior of "Addition on Morris"
    val gSize = 2
    val size = 8
    val rounding = RoundZero

    it should "add 2 values" in {
        test(new AdditionOperationModule(() => Morris(gSize, size, rounding, true))) { c =>
            val nrs : ro.upb.nrs.sl.FixedPrecisionNumberRepresentationSystem = ro.upb.nrs.sl.Morris(0.0d, gSize, size, ro.upb.nrs.sl.RoundZero)
            val a : Int = 127
			...
			c.clock.step()
            val result_nrs : ro.upb.nrs.sl.Morris_B = (value1_nrs + value2_nrs) match {
                case that : ro.upb.nrs.sl.Morris_B => that
                case _ => ro.upb.nrs.sl.Morris_NR(gSize, size, ro.upb.nrs.sl.RoundZero)
            }
...
class TestAdditionExhaustiveMorris extends AnyFlatSpec with ChiselScalatestTester{
    behavior of "Addition on Morris"
    val gSize = 2
    val size = 8
    val rounding = RoundZero
    ...
    it should "exhausting verification +/-" in {
        test(new AdditionOperationModule(() => Morris(gSize, size, rounding, false))) { c =>
            val nrs : ro.upb.nrs.sl.FixedPrecisionNumberRepresentationSystem = ro.upb.nrs.sl.Morris(0.0d, gSize, size, ro.upb.nrs.sl.RoundZero)
...
class TestMultiplicationSingleMorris extends AnyFlatSpec with ChiselScalatestTester{
    behavior of "Multiplication on Morris"
    val gSize = 2
    val size = 8
    val rounding = RoundZero

    it should "multiply 2 values" in {
        test(new MultiplicationOperationModule(() => Morris(gSize, size, rounding, true))) { c =>
            val nrs : ro.upb.nrs.sl.FixedPrecisionNumberRepresentationSystem = ro.upb.nrs.sl.Morris(0.0d, gSize, size, ro.upb.nrs.sl.RoundZero)
            val a : Int = 114
            val binary1 = ro.upb.nrs.sl.auxiliaryFunctions.BinaryEncodetoBinaryString(ro.upb.nrs.sl.auxiliaryFunctions.BinaryEncodeFixedWidth(size, ro.upb.nrs.sl.NaturalNumber(a).binaryEncode))
            val value1_nrs = ro.upb.nrs.benchmark.basicBenchmarkFunctions.fromBinaryString(binary1, nrs)
...
class TestMultiplicationExhaustiveMorris extends AnyFlatSpec with ChiselScalatestTester{
    behavior of "Multiplication on Morris"
    val gSize = 2
    val size = 8
    val rounding = RoundZero
    ...
    it should "exhausting verification *" in {
        test(new MultiplicationOperationModule(() => Morris(gSize, size, rounding, false))) { c =>
            val nrs : ro.upb.nrs.sl.FixedPrecisionNumberRepresentationSystem = ro.upb.nrs.sl.Morris(0.0d, gSize, size, ro.upb.nrs.sl.RoundZero)
			for( i <- 0 until (1<<size)) {//
				for( j <- 0 until (1<<size)) {
                    val binary1 = ro.upb.nrs.sl.auxiliaryFunctions.BinaryEncodetoBinaryString(ro.upb.nrs.sl.auxiliaryFunctions.BinaryEncodeFixedWidth(size, ro.upb.nrs.sl.NaturalNumber(i).binaryEncode))
...
class TestDivisionSingleMorris extends AnyFlatSpec with ChiselScalatestTester{
    behavior of "Division on Morris"
    val gSize = 2
    val size = 8
    val rounding = RoundZero
    it should "Division 2 values" in {
        test(new DivisionOperationModule(() => Morris(gSize, size, rounding, true))) { c =>
            val nrs : ro.upb.nrs.sl.FixedPrecisionNumberRepresentationSystem = ro.upb.nrs.sl.Morris(0.0d, gSize, size, ro.upb.nrs.sl.RoundZero)
            val a : Int = 128
            val binary1 = ro.upb.nrs.sl.auxiliaryFunctions.BinaryEncodetoBinaryString(ro.upb.nrs.sl.auxiliaryFunctions.BinaryEncodeFixedWidth(size, ro.upb.nrs.sl.NaturalNumber(a).binaryEncode))
            val value1_nrs = ro.upb.nrs.benchmark.basicBenchmarkFunctions.fromBinaryString(binary1, nrs)
...
class TestDivisionExhaustiveMorris extends AnyFlatSpec with ChiselScalatestTester{
    behavior of "Division on Morris"
    val gSize = 2
    val size = 8
    val rounding = RoundZero
    ...
    it should "exhausting verification /" in {
        test(new DivisionOperationModule(() => Morris(gSize, size, rounding, false))) { c =>
            val nrs : ro.upb.nrs.sl.FixedPrecisionNumberRepresentationSystem = ro.upb.nrs.sl.Morris(0.0d, gSize, size, ro.upb.nrs.sl.RoundZero)
			for( i <- 0 until (1<<size)) {//
				for( j <- 0 until (1<<size)) {
                    val binary1 = ro.upb.nrs.sl.auxiliaryFunctions.BinaryEncodetoBinaryString(ro.upb.nrs.sl.auxiliaryFunctions.BinaryEncodeFixedWidth(size, ro.upb.nrs.sl.NaturalNumber(i).binaryEncode))
